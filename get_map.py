...
if __name__ == "__main__": 
    ...
    text_path = r"./kaggle/working/VOC_Snow_Split/test"
    degrade_dir = r"./kaggle/working/VOC_Snow_Split/test/images"
    annotation_dir = r"./kaggle/working/VOC_Snow_Split/test/labels"
    image_suffix = '.jpg'
